...
<ImagePlaceholder description="2. Форма регистрации Mostbet" />
```

Описание ОБЯЗАТЕЛЬНО, на русском, конкретное. Каждая заглушка на странице нумеруется: `1. ...`, `2. ...`, `3. ...` — сквозная нумерация в пределах страницы.
