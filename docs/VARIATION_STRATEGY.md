...
<section class="relative overflow-hidden py-16 sm:py-20 lg:py-28">
  ...
  <Image src={heroImg} alt="..." width={1400} height={700}
...
<section class="relative min-h-[80vh] flex items-end overflow-hidden">
  <Image src={heroImg} alt="..." width={1400} height={700}
    ...
    loading="eager" format="webp" quality={70} />
...
<section class="relative overflow-hidden min-h-[70vh] flex items-center">
  ...
  <div class="absolute right-0 top-0 w-1/2 h-full hidden lg:block" style="clip-path: polygon(15% 0, 100% 0, 100% 100%, 0% 100%)">
    <Image src={heroImg} alt="..." width={800} height={700}
      class="w-full h-full object-cover opacity-40"
      loading="eager" format="webp" quality={65} />
...
<section class="relative">
  <div class="relative overflow-hidden pb-24 lg:pb-32">
    <Image src={heroImg} alt="..." width={1400} height={700}
      ...
      loading="eager" format="webp" quality={60} />
    <div class="absolute inset-0 bg-gradient-to-b from-{base}-950/50 via-{base}-950/70 to-{base}-950"></div>
...
**D. Изображение (Canva / Figma / внешний сервис):**
Логотип создаётся в бесплатном дизайн-сервисе (Canva, Figma, Photopea) и кладётся как PNG/SVG в `src/assets/images/logo.png`. Преимущество — поисковики не определят как AI. Лого простой: иконка + текст, не сложная иллюстрация.
```astro
import { Image } from 'astro:assets';
import logo from '../../assets/images/logo.png';
<a href="/">
  <Image src={logo} alt="1xBet KZ" width={120} height={36} loading="eager" format="webp" quality={90} />
</a>
```
...
## 9. Вариативность изображений

### Главная страница
Каждый проект генерирует свои изображения через AI с учётом цветовой схемы проекта. Промпты адаптируются:
- Цвет фона и акцентов — из пресета проекта
- Стилистика — отличается от других проектов (один проект «спортивный», другой «казино-вайб», третий «минималистичный»)

### Подстраницы — какие получают изображения

Не все подстраницы обязаны иметь картинку. Для каждого проекта выбирается 3-5 подстраниц с изображениями.

| Проект | Подстраницы с изображениями |
|---|---|
| 1 | registraciya, skachat, casino |
| 2 | registraciya, casino, bonus, lichnyy-kabinet |
| 3 | skachat, zerkalo, casino |
| 4 | registraciya, casino, bonus |
| 5 | skachat, casino, partnerskaya-programma |

### Изображения слотов

Картинки слотов **предоставляет пользователь вручную** перед генерацией каждого проекта. Агент запрашивает их если они не приложены.

Одинаковые изображения слотов на двух живых проектах — ЗАПРЕЩЕНЫ. Пользователь отвечает за уникальность картинок между проектами.
...
- [ ] Все AI-изображения сгенерированы заново (не скопированы из другого проекта)
- [ ] Изображения слотов — уникальные тематические, не совпадают с другими проектами
- [ ] Минимум 3 подстраницы содержат изображения
- [ ] Общее количество изображений 13-18
